...
public enum Automate
{
	...
	CELLS_NOKEY_QUEST_YES("CELLS_NOKEY_QUEST_STATE1"), CELLS_NOKEY_QUEST_FALSE("CELLS_NOKEY_QUEST_STATE1"), CELLS_NOKEY_QUEST_E(""),
	...
	BREAKROOM_KEY_QUEST_STATE1("BREAKROOM_KEY_QUEST_STATE3"), CELLS_KEY_QUEST_STATE3("CELLS_KEY_QUEST_STATE3"),

	/* On peut se balader,on a parler a John, la quete est TERMINEE,on a les clefs */
	/* la porte de l'infirmerie s'ouvre */
	BREAKROOM_KEY_QUEST_FINISHED("BREAKROOM_KEY_QUEST_FINISHED"), CELLS_KEY_QUEST_FINISHED("CELLS_KEY_QUEST_FINISHED"),
	...
	BREAKROOM_KEY_QUEST_FINISHED_GUARDOK("BREAKROOM_KEY_QUEST_FINISHED_GUARDOK"), CELLS_KEY_QUEST_FINISHED_GUARDOK("CELLS_KEY_QUEST_FINISHED_GUARDOK"), INFIRMARY_KEY_QUEST_FINISHED_GUARDOK("INFIRMARY_KEY_QUEST_FINISHED_GUARDOK"),

	CORRIDOR("CORRIDORK"), OUTSIDE("OUTSIDE"),
